...
// PWA Components
import { PWAUpdateNotification, NetworkStatus as PWANetworkStatus } from "./components/PWANotifications";
...
function App() {
  ...
  useEffect(() => {
    // Show install prompt after some time for better UX
  ...
  return (
    <ErrorBoundary>
      ...
      <Toaster 
        position="top-right"
        toastOptions={{
          duration: config.IS_DEVELOPMENT ? 5000 : 3000,
          style: {
            background: '#363636',
            color: '#fff',
          },
          ...
          error: {
            duration: config.IS_DEVELOPMENT ? 8000 : 5000,
            iconTheme: {
              primary: '#ef4444',
              secondary: '#fff',
            },

      ...
      const mixes: Playlist[] = [
        {
          _id: "daily-mix-1",
          title: "Daily Mix 1",
          imageUrl: await generateMixImage(userRecommendations.itemBased),
          tracks: shuffleArray(userRecommendations.itemBased.slice(0, 15)),
          total_tracks: 15,
          userId: userId,
          user: {
            _id: userId,
          ...
          description:
            "A mix of songs based on your favorites, refreshed daily.",
          createdAt: today,
          updatedAt: today,
          isPublic: false,
        ...
        },
        {
          _id: "daily-mix-2",
          title: "Daily Mix 2",
          imageUrl: await generateMixImage(userRecommendations.userBased),
          tracks: shuffleArray(userRecommendations.userBased.slice(0, 12)),
          total_tracks: 12,
          userId: userId,
          user: {
            _id: userId,
          ...
          description: "Songs inspired by listeners like you, updated daily.",
          createdAt: today,
          updatedAt: today,
          isPublic: false,
          artist: { _id: "daily-mix-artist", name: "Various Artists" },
        ...
        },
        {
          _id: "daily-mix-3",
          title: "Daily Mix 3",
          imageUrl: await generateMixImage(userRecommendations.knowledgeBased),
          tracks: shuffleArray(userRecommendations.knowledgeBased.slice(0, 10)),
          total_tracks: 10,
          userId: userId,
          user: {
            _id: userId,
          ...
          description: "Curated for your mood, refreshed every day.",
          createdAt: today,
          updatedAt: today,
          isPublic: false,
          artist: { _id: "daily-mix-artist", name: "Various Artists" },
        ...
        },
        {
          _id: "daily-mix-4",
          title: "Daily Mix 4",
          imageUrl: await generateMixImage(userRecommendations.hybrid),
          tracks: shuffleArray(userRecommendations.hybrid.slice(0, 10)),
          total_tracks: 10,
          userId: userId,
          user: {
            _id: userId,
          ...
          description: "The best of everything, mixed daily just for you.",
          createdAt: today,
          updatedAt: today,
          isPublic: false,
          artist: { _id: "daily-mix-artist", name: "Various Artists" },
        ...
        },
        {
          _id: "daily-mix-5",
          title: "Daily Mix 5",
          imageUrl: await generateMixImage(
            userRecommendations.demographicBased
          ),
          tracks: shuffleArray(
            userRecommendations.demographicBased.slice(0, 10)
          ),
          total_tracks: 10,
          userId: userId,
          user: {
          ...
          description: "Hits from your region, updated daily.",
          createdAt: today,
          updatedAt: today,
          isPublic: false,
          artist: { _id: "daily-mix-artist", name: "Various Artists" },
